...
In order to support loading of multiple wallets in xgamingup-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xgamingup.cpp.
...
Changes to xgamingup.cpp
----------------------
xgamingup.cpp is the entry point into xgamingup-qt, and as such, will require some minor modifications to provide hooks for
