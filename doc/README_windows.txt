...
Intro
-----
XgamingUP (XGA) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. XgamingUP utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run xgamingup-qt.exe.

XgamingUP Core is the original XgamingUP client and it builds the backbone of the network.
However, it downloads and stores the entire history of XgamingUP transactions;
