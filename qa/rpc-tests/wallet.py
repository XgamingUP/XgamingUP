...
#   c) node1 mines 32 blocks, so now node 0 has 500000XGA, node 1 has 4250XGA, node2 has none.
#   d) node0 sends 601 XGA to node2, in two transactions (301 XGA, then 300 XGA).
