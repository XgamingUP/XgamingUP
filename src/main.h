...
inline int64_t GetMNCollateral1(int nHeight) {
	...
	if (nHeight < 35300) {
		return 1000;
	} else if (nHeight >= 35300 && nHeight < 45300) {
		return 2000;
	} else if (nHeight >= 45300 && nHeight < 55300) {
		return 3000;
	} else if (nHeight >= 55300 && nHeight < 65300) {
		return 4000;
	} else if (nHeight >= 65300 && nHeight < 75300) {
		return 5000;
	} else if (nHeight >= 75300 && nHeight < 85300) {
		return 7000;
