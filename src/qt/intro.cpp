...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("XgamingUP Core"),
     ...
     * override -datadir in the xgamingup.conf file in the default data directory
     * (to be consistent with xgamingupd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
