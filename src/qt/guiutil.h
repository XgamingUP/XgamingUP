...
/** Utility functions used by the XgamingUP Qt UI.
 */
namespace GUIUtil
{
...
// Render XGA addresses in monospace font
...
// Parse "xgamingup:" URI into recipient object, return true on successful parsing
