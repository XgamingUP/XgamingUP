...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XgamingUP Core xgamingup-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xgamingup-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xgamingup transaction") + "\n" +
                               "  xgamingup-tx [options] -create [commands]   " + _("Create hex-encoded xgamingup transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xgamingup transaction
