...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop XgamingUP server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "XgamingUP server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XgamingUP features */
        {"xgamingup", "masternode", &masternode, true, true, false},
        {"xgamingup", "listmasternodes", &listmasternodes, true, true, false},
        {"xgamingup", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xgamingup", "masternodeconnect", &masternodeconnect, true, true, false},
        {"xgamingup", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xgamingup", "masternodedebug", &masternodedebug, true, true, false},
        {"xgamingup", "startmasternode", &startmasternode, true, true, false},
        {"xgamingup", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xgamingup", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xgamingup", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xgamingup", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xgamingup", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xgamingup", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xgamingup", "mnbudget", &mnbudget, true, true, false},
        {"xgamingup", "preparebudget", &preparebudget, true, true, false},
        {"xgamingup", "submitbudget", &submitbudget, true, true, false},
        {"xgamingup", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xgamingup", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xgamingup", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xgamingup", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xgamingup", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xgamingup", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"xgamingup", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xgamingup", "checkbudgets", &checkbudgets, true, true, false},
        {"xgamingup", "mnsync", &mnsync, true, true, false},
        {"xgamingup", "spork", &spork, true, true, false},
        {"xgamingup", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"xgamingup", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"xgamingup", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"xgamingup", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"xgamingup", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"xgamingup", "mncommunityvote", &mncommunityvote, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> xgamingup-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17141/\n";
}
