...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/xgamingup-cli.cpp \
           src/xgamingup-tx.cpp \
           src/xgamingup.cpp \
           src/db.cpp \
           ...
           src/qt/xgamingup.cpp \
           src/qt/xgamingupstrings.cpp \
...
RESOURCES += src/qt/xgamingup.qrc src/qt/xgamingup_locale.qrc

TRANSLATIONS += src/qt/locale/xgamingup_bg.ts \
                src/qt/locale/xgamingup_de.ts \
                src/qt/locale/xgamingup_en.ts \
                src/qt/locale/xgamingup_es.ts \
                src/qt/locale/xgamingup_fi.ts \
                src/qt/locale/xgamingup_fr.ts \
                src/qt/locale/xgamingup_it.ts \
                src/qt/locale/xgamingup_ja.ts \
                src/qt/locale/xgamingup_pl.ts \
                src/qt/locale/xgamingup_pt.ts \
                src/qt/locale/xgamingup_ru.ts \
                src/qt/locale/xgamingup_sk.ts \
                src/qt/locale/xgamingup_sv.ts \
                src/qt/locale/xgamingup_vi.ts \
                src/qt/locale/xgamingup_zh_CN.ts \
                src/qt/locale/xgamingup_zh_TW.ts
