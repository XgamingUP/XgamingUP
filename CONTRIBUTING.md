Contributing to XgamingUP Core
==================================

The XgamingUP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the XgamingUP Core project, and is not to be
confused with overall XgamingUP Network Protocol consensus changes.

Whether a pull request is merged into XgamingUP Core rests with the project merge
...
Patches that change XgamingUP consensus rules are considerably more involved than
...
Where a patch set proposes to change the XgamingUP consensus, it must have been
...
The project leader is the release manager for each XgamingUP Core release.
